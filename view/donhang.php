<?php
// Đoạn mã PHP để lấy giá trị tổng thanh toán từ session
$tongthanhtoan = isset($_SESSION['tongdonhang']) ? $_SESSION['tongdonhang'] : 0;
?>
            ...
            <div class="col9 viewcart">
                <div class="ttdathang">
                    <h2>Thông tin người đặt hàng</h2>
                      ...
                      <input type="text" placeholder="Nhập họ tên đầy đủ" name="hoten" id="hoten" required><br><br>
        ...
        <div class="boxcart">
            ...
            <div class="total">
                    <div class="boxcart bggray">
                        ...
                        <h3>Tổng thanh toán: <?php echo number_format($tongthanhtoan); ?></h3>
                    </div>
            </div>
