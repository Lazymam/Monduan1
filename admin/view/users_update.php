...
<div class="main-content">
    ...
    <form class="addPro" action="index.php?pg=updateusers" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <button type="submit" name="updateusers" class="btn btn-primary">Cập nhật</button>
        </div>
        <?php if(isset($tb)&&($tb!="")){ 
            echo $tb;
        }
