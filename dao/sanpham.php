...
{
    if ($img != "") {
        $sql = "UPDATE sanpham SET name=?,price=?,iddm=?,img=? WHERE id=?";
        pdo_execute($sql, $name, $price, $iddm, $img, $id);
    } else {
