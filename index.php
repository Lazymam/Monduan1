<?php
    ...
    $dssp_cafe=get_dssp_cafe(4);
    $dssp_tra=get_dssp_tra(4);
    if(!isset($_GET['pg'])){
        ...
        switch ($_GET['pg']) {
            ...
            case 'login':
                ...
                if(isset($_POST["dangnhap"])&&($_POST["dangnhap"])){
                    ...
                    $donhang=$_POST['doanhang'];
                    //xl: kiem tra
                    $kq=checkuser($username,$password);
                    if(is_array($kq)&&(count($kq))){
                        $_SESSION['s_user']=$kq;
                        if($donhang==1){ //click đnhap từ trang giỏ hàng
                            header('location: index.php?pg=donhang');
                        }else if($_SESSION['trang']=="sanphamchitiet"){//click đnhap từ trang bình luận
            ...
            case 'donhangsubmit':
                if(isset($_POST['donhangsubmit'])){
                    ...
                    // tạo đơn hàng
                    $madh="Zhope".$iduser."-".date("Hís-dmY");
                    ...
                    header('location: index.php?pg=donhang_confirm&madh'.$madh);
